...
router.route("/updateactivity/:id").put(activityController.updateActivity);
...
router.route("/task/newTask/:activity_id").post(taskController.createTask);
...
router.route("/updateTask/:task_id").put(taskController.updateTask);
...
router.route("/getAll").get(verifyJWT, projectController.handleGetAllProjects);
...
router.route("/comment/:comment_id").get(CommentController.getCommentById);
...
router.route("/updatecomment/:comment_id").put(CommentController.updateComment);
router
